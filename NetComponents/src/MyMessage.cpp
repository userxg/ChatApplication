...
namespace Net
{
	...
	{
		inp >> msg.sd.is_new_client >> msg.sd.name_is_taken >> msg.sd.client_name >> msg.sd.password 
			>> msg.sd.penpals_cnt >>
	...
	{
		out << msg.sd.is_new_client << msg.sd.name_is_taken << msg.sd.client_name << msg.sd.password 
			<< msg.sd.penpals_cnt
			<< msg.cd.from << msg.cd.to << msg.cd.message;
